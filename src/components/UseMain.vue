...
<template>
  <div class="bg-[#283652] w-full pb-1 flex place-content-center">
    <div class="mt-[176px] max-w-[1440px] flex place-content-center px-5">
      <div class="text-center">
        ...
        <div class="flex sm:flex-row flex-col gap-[36px] place-content-center mt-[44px]">
          ...
          <button class="bg-white text-black font-bold text-[18px] px-[24px] py-[8px] rounded-full">
            Get in touch {{ '>' }}
          </button>
        </div>
        <div class="flex place-content-center mt-[100px] max-w-[1040px]">
          <video src="/video/heromain.mp4" autoplay muted playsinline class=""></video>
        </div>
      </div>
    </div>
  </div>
